...
function Cart() {
    ...
    return (
        <div className="bg-white shadow-lg absolute z-50 w-80">
            <div className="mx-auto">
                <div className="bg-black p-4">
                    <h1 className="text-xl font-semibold text-white text-center">Your Cart</h1>
                </div>
                ...
                <div className="px-4 py-6">
                    ...
                    <div className="mt-6 border-t border-gray-200 pt-6">
                        <div className="flex items-center justify-between">
                            ...
                            {/* <p className="text-sm font-medium text-gray-900">₹{cartItems.reduce((total, item) => total + item.product.price * item.product.quantity, 0)}</p> */}
                        </div>
                        <div className="mt-6">
